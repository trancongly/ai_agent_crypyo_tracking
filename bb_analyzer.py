...
class BollingerStructureAnalyzer:
    """
    Bollinger Band Structure Analyzer
    ...
    def analyze(
        ...
        bb_position = (
            self._calculate_bb_position(df)
        )
